    ...
    if active_tab == "registros":
        ...
        return html.Div(
            [
                ...
                dbc.Row(
                    [
                        ...
                        dbc.Col(
                            html.Div(
                                [
                                    html.H5("Reconocimiento de Objetos", style={'color': 'white', 'textAlign': 'center'}),
                                    html.Img(
                                        id="video-feed-2",
                                        style={
                                            'width': '1280px',
                ...
                # Canvas para el stream YOLO
                html.H4("Cámara YOLO", style={'color': 'white', 'textAlign': 'center', 'marginTop': '20px'}),
                html.Div(
                    [
                        html.Canvas(
                            id="videoCanvas",
...
@app.callback(
    [Output("video-feed-1", "src"), Output("video-feed-2", "src"), Output("video-feed-3", "src")],
